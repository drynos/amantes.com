    ...
    <div className="flex flex-col h-screen w-screen bg-zinc-950 text-zinc-100 font-sans overflow-hidden">
      ...
      <nav className="h-20 bg-zinc-950 border-t border-zinc-900 flex items-center justify-between px-2 pb-2 z-50 shrink-0">
        ...
        <NavItem 
          target={AppMode.SHOP} 
          label="Packs"
          icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill={mode === AppMode.SHOP ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={mode === AppMode.SHOP ? 0 : 2}><path strokeLinecap="round" strokeLinejoin="round" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>}
        />
